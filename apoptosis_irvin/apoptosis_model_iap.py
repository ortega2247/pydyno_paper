...
# Modified by Oscar Ortega -- Lopez Lab -- 2020-07-03. Added IAP interactions
"""
========================================
...
11. Inhibitor of apoptosis protein iap + *eCaspases | iap%*eCapases
...
# 12. Inhibition of *eCapase
Parameter('kf10', 1.0e-06)
Parameter('kr10', 1.0e-03)
Rule('iap_bind_activated_ecaspase', EC(b=None, state='active') + IAP(b=None) | EC(b=1, state='active') % IAP(b=1),
     kf10, kr10)
