...
#carrying_capacity_each_subtype = float(1000000)
...
#Expression('k_NE_CC',(k_NE_div-k_NE_die) / carrying_capacity_each_subtype)
#Rule('NE_CC', NE() + NE() >> NE(), k_NE_CC)
...
#Expression('k_NEv1_CC',(k_NEv1_div-k_NEv1_die) / carrying_capacity_each_subtype)
#Rule('NEv1_CC', NEv1() + NEv1() >> NEv1(), k_NEv1_CC)
...
#Expression('k_NonNE_CC',(k_nonNE_div-k_nonNe_die) / carrying_capacity_each_subtype)
#Rule('NonNE_CC', NonNE() + NonNE() >> NonNE(), k_NonNE_CC)
